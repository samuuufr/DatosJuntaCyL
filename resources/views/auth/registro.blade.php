    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl p-8 transform hover:scale-[1.01] transition-all duration-300" style="background-color: var(--bg-secondary); border: 1px solid var(--border-color); box-shadow: var(--shadow-lg);">
            ...
            <form action="{{ route('registro.post') }}" method="POST" class="space-y-5">
                ...
                <!-- Nombre -->
                <div class="group">
                    <label for="nombre" class="block text-sm font-semibold mb-2" style="color: var(--text-primary);">
                        Nombre Completo
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    ...
                    <p class="mt-1 text-xs" style="color: var(--text-secondary);">Usa al menos 6 caracteres</p>
                </div>

                <!-- Confirmar Contraseña -->
                <div class="group">
                    <label for="password_confirmation" class="block text-sm font-semibold mb-2" style="color: var(--text-primary);">
                        Confirmar Contraseña
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
